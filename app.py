...
if uploaded_file is not None:
    ...
    st.write("Analyzing video... This may take a moment.")
    ...
    try:
        ...
        st.error("Could not detect a valid pit stop. Please ensure the video shows the car stopping and that the app is set to Python 3.9.")
